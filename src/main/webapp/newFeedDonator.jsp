...
<head>
    ...
    <!-- Custom CSS -->
    <link href="./css/donator.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none;">
                        <span style="font-size: 25px; margin-left: 20px; color: #CD3700; ">Donator</span>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="newsfeedDonator.html">
                        <img src="./pic/text-lines.png" height="20px" width="20px">
                    </a>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <img src="./pic/chat2.png" height="20px" width="20px">
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                <div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-profile">
                            ...
                            <h5 align="center">(Donator)</h5>
                        </li>
                        <li>
                            <a href="matchingDonator.html"><img src="./pic/search.png"></i> <span id="test">Matching</span></a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="create-post">
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal" ><span id="create">+ CREATE POST</span></button>
                </div>
