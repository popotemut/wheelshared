<%-- 
    Document   : MatchingReciever
    Created on : Feb 20, 2018, 3:51:37 PM
    Author     : OWNER
--%>
                ...
                <div class="row">
                    ...
                    <form role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio">
                            <label>
                                <input type="radio" value="">Wheelchair
                            </label>
                            <label>
                                <input type="radio" value="">Oxygen tank
                            </label>
                            <label>
                                <input type="radio" value="">Crutches
                            </label>
                            <label>
                                <input type="radio" value="">Bed
                            </label>
                            <label>
